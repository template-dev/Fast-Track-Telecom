...
#gcc -Isrc -o build/decoder server_decoder.cpp src/*.c -DPDU=Registration -DASN_DISABLE_OER_SUPPORT
gcc -Isrc -o build/coder client_coder.cpp src/*.c -DPDU=Registration -DASN_DISABLE_OER_SUPPORT -lsctp -lstdc++
gcc -Isrc -o build/decoder server_decoder.cpp src/*.c -DPDU=Registration -DASN_DISABLE_OER_SUPPORT -lsctp -lstdc++
